...
// the result table has measurement items (functions), this delegate will display the details for the line kind.
    ...
    Column {
        ...
        ResultTableDelegateRow {
            ...
            _label: resultTable.totalCount === 1 ? "" : typeCount === 1 ?
                    //: Label for line meter result in measure result table. Keep as short as possible.
                    //% "line"
                    qsTrId("ID_RESULT_LINE") :
                    //: Label for line meter result in measure result table. Keep as short as possible. '%1' is a placeholder for an ID (number).
                    //% "ln%1"
                    qsTrId("ID_RESULT_LINE_INDEX").arg(typeIndex + 1) + translation.update
            _value: value
            onWidthsChanged: resultTable.recalcDelegateWidth(index, 1, column1Width, column2Width, 0, resultLineDelegate.height);
        }
        ...
        ResultTableDelegateAlarmRow {
            ...
            onWidthsChanged: resultTable.recalcDelegateWidth(index, 2, column1Width, column2Width, column3Width, resultLineDelegate.height);
        }
        ...
        ResultTableDelegateAlarmRow {
            ...
            onWidthsChanged: resultTable.recalcDelegateWidth(index, 3, column1Width, column2Width, column3Width, resultLineDelegate.height);
        }
        ...
        ResultTableDelegateAlarmRow {
            ...
            onWidthsChanged: resultTable.recalcDelegateWidth(index, 4, column1Width, column2Width, column3Width, resultLineDelegate.height);
        }
    }
}
